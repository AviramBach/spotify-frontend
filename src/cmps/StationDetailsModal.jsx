        ...
        <div className="modal">
            <div className="modal-header">
                ...
                <button className="modal-close-button" onClick={() => { handleClose }}>
                    <img crossorigin="anonymous" className="modal-close-button-img" src="https://res.cloudinary.com/dollaguij/image/upload/v1699194245/svg/x_ti24ab.svg" alt="" onClick={() => handleClose} />
                </button>
            </div>
